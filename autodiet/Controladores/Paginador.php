...
class Paginador {
    ...
    public function crearLinks($enlaces) {
        ...
        $clase = ($this->pagina == 1) ? "" : "";
        $html = '<li class="' . $clase . '" id="lipag"><a href="?limit=' . $this->limite . '&page=' . ($comienzo) . '">&laquo;</a></li>';
        ...
        $html .= '<li class="' . $clase . '" id="lipag"><a href="?limit=' . $this->limite . '&page=' . ($fin) . '">&raquo;</a></li>';
        return $html;
    }
